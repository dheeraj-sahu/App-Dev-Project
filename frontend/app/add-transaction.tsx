...
export default function AddTransactionScreen() {
    ...
    const { amount: paramAmount, title: paramTitle, category: paramCategory, date: paramDate } = useLocalSearchParams();
    ...
    }, [paramAmount, paramTitle, paramCategory, paramDate]);
    ...
    const handleSave = () => {
        ...
        // Construct date from current date + selected time
        ...
        addTransaction({
            ...
            color: type === 'expense' ? '#D32F2F' : '#2E7D32',
            location: location || 'Kolkata',
            latitude: coordinates?.latitude,
            longitude: coordinates?.longitude,
            time: time,
            category: category || 'General',
            paymentMethod: subtitle, // Using subtitle as payment method for consistency
                    ...
                    <View style={styles.segmentContainer}>
                        <TouchableOpacity
                            style={[
                                ...
                                type === 'expense' && { backgroundColor: '#ffebee' }
                            ]}
                        ...
                        <TouchableOpacity
                            style={[
                                ...
                                type === 'income' && { backgroundColor: '#e8f5e9' }
                            ]}
                            onPress={() => setType('income')}
                        >
                            <Text style={[
                                styles.segmentText,
                                type === 'income' && { color: '#2E7D32', fontWeight: 'bold' }
                            ]}>Income</Text>
                        </TouchableOpacity>
                    </View>
                                ...
                                <View style={{ flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#e0e0e0' }}>
                                    ...
                                    <TouchableOpacity onPress={handleGetLocation} style={{ padding: 4 }}>
                                        {isLoadingLocation ? (
                                            ...
                                            <Ionicons name="location-outline" size={20} color="#004D40" />
                                        )}
                                    </TouchableOpacity>
                                </View>
                            </View>
